const CACHE='mpw-clean-1.0.0';
const STATIC=['./','./index.html','./styles-clean.css','./core.js','./content.js','./modules.js','./app-clean.js','./manifest.webmanifest','./assets/icon-192.png','./assets/icon-512.png'];
