const CACHE='mpw-clean-1.0.5';
const STATIC=['./','./index.html','./styles-clean.css','./procedures-grid.css','./navigation-repair.css','./header-logo.css','./core.js','./content.js','./modules.js','./app-clean.js','./manifest.webmanifest','./assets/icon-192.png','./assets/icon-512.png','./assets/logo-mark.png'];
