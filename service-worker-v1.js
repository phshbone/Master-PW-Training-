const CACHE='mpw-clean-1.0.3';
const STATIC=['./','./index.html','./styles-clean.css','./procedures-grid.css','./core.js','./content.js','./modules.js','./app-clean.js','./manifest.webmanifest','./assets/icon-192.png','./assets/icon-512.png'];
